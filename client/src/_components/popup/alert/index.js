  ...
  render() {
    ...
    return(
      <div className={'alert flex fixed top-16 w-screen z-50 ' + (alert.message ? 'display: block' : 'display: none')}>
        {alert.message && 
          <div className={'text-center ' + statusStyle + ' p-8 m-auto rounded-xl border-2 border-black'} role="alert">
            <div>
            ...
            <div className="w-0 h-0">
              <svg className="icon fill-current h-6 w-6 text-red-500" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" onClick={this.dismissHandler()}>
                <title>Close</title>
